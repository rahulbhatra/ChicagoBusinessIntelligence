...
router.get('/data', async (req, res) => {
    ...
    try {        
        await sequelize.query(`select Id, "areaCode", "areaName", "percentBelowPoverty", "percentUnemployed" from unemployment_poverty_data order by "percentBelowPoverty" desc limit 5;`
